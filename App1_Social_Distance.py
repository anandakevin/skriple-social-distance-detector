...
def cvDrawBoxes(detections, img):
    ...
    #=================================================================            	
        ...
        print(red_line_list)
        print(red_line_list[0])
        print(red_line_list[0][0], red_line_list[0][1])
...
def YOLO():
    ...
    #.mp4 > MPAV
    out = cv2.VideoWriter(
            "./Output/video3_output.avi", cv2.VideoWriter_fourcc(*"MJPG"), 10.0,
            (new_width, new_height))
    # out = cv2.VideoWriter(
    #         "./Output/video3_output.mp4", cv2.VideoWriter_fourcc(*"MPAV"), 14,
